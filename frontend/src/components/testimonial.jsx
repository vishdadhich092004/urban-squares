...
const Testimonials = () => {
  ...
  return (
    <section className="relative flex h-[50rem] w-full items-center justify-center bg-white dark:bg-black">
      {/* Dot background */}
      <div
        className={cn(
          "absolute inset-0",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover why homeowners trust UrbanSquare to find their perfect
            property
          </p>
        </motion.div>
