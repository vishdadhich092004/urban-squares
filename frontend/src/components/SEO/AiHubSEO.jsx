...
const AiHubSEO = () => {
  return (
    <Helmet>
      <title>
        AI Property Hub | UrbanSquare - Market Trends & Property Analysis
      </title>
      <meta
        name="description"
        content="Use UrbanSquare's AI Property Hub to analyze real estate trends, compare property values, and get location-specific investment insights powered by advanced AI."
      />
      <meta
        name="keywords"
      ...
      <meta property="og:title" content="AI Property Hub | UrbanSquare" />
      <meta
      ...
      <meta
        property="og:url"
        content="https://UrbanSquare.vercel.app/ai-property-hub"
      />
